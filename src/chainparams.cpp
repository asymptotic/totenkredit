 ...
 *
 * stuff shardy added:
 * 04ffff001d0104154c6f6e67206c6976652074686520456d7069726521
 * algorithm: scrypt
 * merkle hash: 4e166a08a63e65921fcf2b6fe26de5aa8c6df324e3ab9bab87476dde1954193d
 * pszTimestamp: Long live the Empire!
 * pubkey: 04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f
 * time: 1513293665
 * bits: 0x1e0ffff0
 * nonce: 208804247
 * genesis hash: 2cc27a1390189624999733b531d9afdec6e2ce4a4fc821b67aa8b224f1589291
 */
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    const char* pszTimestamp = "Long live the Empire!";
...
public:
	...
	consensus.nMinimumChainWork = uint256S("0x64");
        ...
        genesis = CreateGenesisBlock(1513293665, 208804247, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2cc27a1390189624999733b531d9afdec6e2ce4a4fc821b67aa8b224f1589291"));
        assert(genesis.hashMerkleRoot == uint256S("0x4e166a08a63e65921fcf2b6fe26de5aa8c6df324e3ab9bab87476dde1954193d"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.totenkredit.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("totenkredittools.com", "dnsseed.totenkredittools.com"));
        //vSeeds.push_back(CDNSSeedData("totenkreditpool.org", "dnsseed.totenkreditpool.org"));
        //vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
	vSeeds.push_back(CDNSSeedData("totenkitten.org", "tkk.totenkitten.org"));
...
public:
    CTestNetParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("totenkredittools.com", "testnet-seed.totenkredittools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.totenkredit.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
	vSeeds.push_back(CDNSSeedData("totenkitten.org", "tkk-testnet.totenkitten.org"));
