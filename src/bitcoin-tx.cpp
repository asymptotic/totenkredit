...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s totenkredit-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  totenkredit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded totenkredit transaction") + "\n" +
              "  totenkredit-tx [options] -create [commands]   " + _("Create hex-encoded totenkredit transaction") + "\n" +
              "\n";
