...
void Shutdown()
{
    ...
    RenameThread("totenkredit-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/totenkredit-project/totenkredit>";
    const std::string URL_WEBSITE = "<https://totenkredit.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("totenkredit-loadblk");
    CImportingNow imp;
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Totenkredit version %s\n", FormatFullVersion());
}
