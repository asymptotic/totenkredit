Totenkredit Core version 0.13.3 is now available from:

  <https://download.totenkredit.org/totenkredit-0.13.3/>
...
Totenkredit Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
This only affects users that have explicitly enabled UPnP through the GUI setting or through the -upnp option, as since the last UPnP vulnerability (in Totenkredit Core 0.10.4) it has been disabled by default.
...
- http://testnet.totenkredittools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/totenkredit-project/totenkredit/blob/0.13/src/chainparams.cpp#L214).
